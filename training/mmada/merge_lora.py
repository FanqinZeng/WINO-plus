...
def parse_args():
    parser = argparse.ArgumentParser(description="Merge an MMaDA LoRA adapter into a base MMaDA model.")
    parser.add_argument("--base-model", required=True, help="Path or Hugging Face id for the base MMaDA model.")
    ...
    parser.add_argument("--tokenizer", default=None, help="Tokenizer path. Defaults to --base-model.")
...
def main():
    ...
    print(f"Loading base MMaDA model from: {args.base_model}")
